...
function App() {
  ...
  const CustomScanTooltip = ({ active, payload, label }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-slate-950/95 border border-slate-800 p-4 rounded-xl shadow-2xl backdrop-blur-md text-xs font-sans text-slate-350 space-y-1.5 min-w-[245px]">
          <p className="font-extrabold text-white border-b border-slate-800 pb-1 mb-1 font-mono uppercase tracking-wider text-[10px] text-purple-400">
            Scan {data.scanId}
          </p>
          <div className="space-y-1 text-[9px] font-mono">
            ...
            {hasSpikeExplanation && (
              <div className="border-t border-purple-950/50 pt-1.5 mt-1.5 text-[8px] text-purple-300 bg-purple-950/20 p-1.5 rounded border border-purple-900/30">
                <p className="font-sans font-bold uppercase text-[8px] text-purple-400 mb-0.5">💡 Explanation of Trend Change</p>
  ...
  return (
    <div className="min-h-screen bg-[#070b13] text-slate-100 flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-slate-950/80 backdrop-blur-md border-b border-slate-900 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-purple-400 -mt-0.5 font-semibold">DEFECT PLATFORM v2</p>
          </div>
        </div>

        <div className="flex items-center gap-6">
          <div className="hidden sm:flex items-center gap-3 border-r border-slate-800 pr-6">
            <div className="w-8 h-8 rounded-full bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 font-bold uppercase text-sm">
          ...
          <button
            ...
            className="p-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white rounded-lg transition"
            title="Log Out"
          >
            <LogOut size={18} />
          </button>
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        {/* Navigation Sidebar */}
        <aside className="w-full md:w-64 bg-slate-950/40 border-r border-slate-950 p-4 space-y-2 flex flex-col justify-between">
        ...
        <main className="flex-1 p-6 md:p-8 bg-[#090d16] overflow-y-auto max-w-full">
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
                ...
                <div className="lg:col-span-1 flex justify-end gap-3">
                  {user.role === 'ADMIN' ? (
                    <button
                      onClick={() => setActiveTab('pipeline')}
                      className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg text-xs hover:bg-purple-700 transition shadow-lg shadow-purple-500/10 flex items-center gap-1.5"
                    >
                      <Zap size={14} />
                      <span>Trigger Custom Scan</span>
                    </button>
                  ) : (
                    <div className="px-3 py-1.5 bg-slate-950 border border-slate-850 rounded-lg text-[10px] font-semibold text-slate-400 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-2xl flex flex-col justify-between h-32 relative group overflow-hidden">
                ...
                <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-2xl flex flex-col justify-between h-32 relative group overflow-hidden">
                  ...
                  <div className="flex justify-between items-baseline mt-2">
                    ...
                    <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${criticalHotspots > 0 ? 'bg-rose-500/10 text-rose-400 border border-rose-500/20' : 'bg-slate-900 text-slate-400'}`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* AI Explainer Panel */}
                <div className="lg:col-span-2 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl flex flex-col justify-between min-h-[350px]">
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      <span className="inline-block p-1 bg-purple-500/15 border border-purple-500/30 text-purple-400 rounded-md">
                        <Activity size={16} />
                      </span>
                  ...
                  <div className="pt-4 border-t border-slate-850 flex justify-between items-center text-xs text-slate-500">
                ...
                <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl h-[350px] flex flex-col">
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-slate-800 flex justify-between items-center">
                  ...
                  <button
                    onClick={() => setActiveTab('risks')}
                    className="px-3 py-1.5 bg-slate-950 border border-slate-850 hover:bg-slate-900 rounded-lg text-xs font-bold text-slate-300 transition"
                  >
                    View All Rankings
                  </button>
                </div>
                    ...
                    <table className="w-full text-left border-collapse text-xs">
                      ...
                      <tbody className="divide-y divide-slate-850/30 text-slate-300 font-mono">
                        {risks.slice(0, 5).map((r, i) => (
                          <tr key={r.id || i} className="hover:bg-slate-900/20 transition">
                            <td className="py-4 px-6 font-bold text-purple-400">#{i + 1}</td>
                            <td className="py-4 px-6 font-semibold text-slate-200 hover:text-purple-400 cursor-pointer" onClick={() => fetchExplainability(r.module)}>{r.module}</td>
          ...
          {activeTab === 'rules' && (
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                ...
                {rules.length > 0 && (
                  <button
                    ...
                    className="px-4 py-2 bg-slate-900 border border-slate-800 text-slate-350 hover:text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition"
                  >
                    <Download size={14} />
              ...
              <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                  <div className="md:col-span-2 relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-9 pr-3 py-2 bg-slate-950 border border-slate-850 rounded-lg text-xs text-white placeholder-slate-650 focus:outline-none"
                    />
                  </div>
                  ...
                  <div>
                    <select
                      ...
                      className="block w-full px-3 py-2 bg-slate-950 border border-slate-850 rounded-lg text-xs text-white focus:outline-none"
                    >
                  ...
                  <div>
                    <input
                      ...
                      className="block w-full px-3 py-2 bg-slate-950 border border-slate-850 rounded-lg text-xs text-white placeholder-slate-650 focus:outline-none"
                    />
                  </div>
                ...
                <div className="flex justify-between items-center mt-4 pt-4 border-t border-slate-850/40 text-[10px] text-slate-500 font-mono">
                  <div className="flex gap-4">
                    <span>Sort metric: 
                      <button onClick={() => setRulesSortBy('lift')} className={`ml-1 font-bold ${rulesSortBy === 'lift' ? 'text-purple-400 underline' : ''}`}>Lift</button> / 
                      <button onClick={() => setRulesSortBy('confidence')} className={`ml-1 font-bold ${rulesSortBy === 'confidence' ? 'text-purple-400 underline' : ''}`}>Confidence</button> / 
                      <button onClick={() => setRulesSortBy('support')} className={`ml-1 font-bold ${rulesSortBy === 'support' ? 'text-purple-400 underline' : ''}`}>Support</button>
                    </span>
                    <span>Order: 
                      <button onClick={() => setRulesSortDesc(true)} className={`ml-1 font-bold ${rulesSortDesc ? 'text-purple-400 underline' : ''}`}>Descending</button> / 
                      <button onClick={() => setRulesSortDesc(false)} className={`ml-1 font-bold ${!rulesSortDesc ? 'text-purple-400 underline' : ''}`}>Ascending</button>
                    </span>
                  </div>
                          ...
                          {getRuleClusters(rules).slice(rulesPage * 10, (rulesPage + 1) * 10).map((cluster, clusterIdx) => {
                            ...
                            return (
                              <React.Fragment key={cluster.id}>
                                <tr className="hover:bg-slate-900/20 transition border-b border-slate-850/30">
                                  <td className="py-4 px-6 text-purple-400 font-bold">#{rulesPage * 10 + clusterIdx + 1}</td>
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      {cluster.collapsed.length > 0 && (
                                        <button
                                          ...
                                          className="px-2 py-0.5 rounded-full bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 hover:border-purple-500/40 text-[9px] font-sans font-bold text-purple-300 transition-all flex items-center gap-1 active:scale-95"
                                        >
                                ...
                                {isExpanded && cluster.collapsed.map((child, childIdx) => (
                                  <tr key={childIdx} className="bg-purple-950/5 border-b border-slate-850/10 text-slate-400 font-mono transition-all">
                                    ...
                                    <td className="py-2.5 px-6 text-[10px] text-purple-400/80">{child.lift.toFixed(2)}</td>
                                  </tr>
                                ))}
                              </React.Fragment>
                            );
                      ...
                      <div className="p-4 bg-slate-950/60 border-t border-slate-850 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="p-1.5 bg-slate-900 border border-slate-800 disabled:opacity-40 text-slate-400 hover:text-white rounded-lg transition"
                          >
                            <ChevronLeft size={16} />
                          </button>
                          <button
          ...
          {activeTab === 'graph' && (
            <div className="space-y-8 h-[calc(100vh-180px)] flex flex-col">
              ...
              <div className="flex-1 bg-slate-900/40 border border-slate-800 rounded-2xl overflow-hidden relative min-h-[400px]">
                {rules.length === 0 ? (
                  ...
                  >
                    ...
                    <MiniMap
                      ...
                      className="bg-slate-900/80 border border-slate-850 rounded-xl"
                ...
                {selectedGraphNode && (() => {
                  ...
                  return (
                    <div className="absolute top-4 right-4 bottom-4 w-80 z-10 bg-slate-950/95 border border-slate-850 p-4 rounded-xl flex flex-col shadow-2xl backdrop-blur-md overflow-hidden animate-slide-in font-sans">
                      <div className="flex justify-between items-start border-b border-slate-800 pb-3 mb-3">
                        <div>
                          <span className="text-[9px] font-bold text-purple-400 uppercase tracking-wider block">{typeLabel}</span>
                          <h4 className="text-sm font-bold text-white font-mono mt-0.5">{label}</h4>
                        </div>
                        <button 
                          onClick={() => setSelectedGraphNode(null)}
                          className="p-1 rounded bg-slate-900/50 border border-slate-850 hover:border-slate-700 transition text-slate-400 hover:text-white"
                        >
                          <X size={14} />
                        </button>
                      </div>
                          ...
                          {relatedRules.length === 0 ? (
                            ...
                            <div className="space-y-2">
                              {relatedRules.slice(0, 15).map((rule, idx) => {
                                ...
                                return (
                                  <div key={idx} className="p-2.5 bg-slate-900/40 border border-slate-850 hover:border-slate-800 rounded-lg transition space-y-2">
                                    <div className="text-slate-300 font-mono leading-tight">
                                      <span className="text-purple-400 font-bold">{antecedentsClean}</span>
                                      <span className="text-slate-400 mx-1">→</span>
                                      <span className={
                                        outcomeClean === 'CRITICAL' ? 'text-rose-400 font-bold' :
                                        outcomeClean === 'HIGH' ? 'text-orange-400 font-bold' :
                                        outcomeClean === 'MEDIUM' ? 'text-amber-400 font-bold' : 'text-blue-400 font-bold'
                                      }>{outcomeClean}</span>
                                    </div>
                                    <div className="flex gap-2.5 text-[9px] font-mono text-slate-450 border-t border-slate-850/30 pt-1.5">
                ...
                {/* Graph Legend Panel */}
                <div className="absolute bottom-4 left-4 z-10 bg-slate-950/90 border border-slate-850 p-4 rounded-xl text-[10px] space-y-2 max-w-xs shadow-2xl backdrop-blur-md">
          ...
          {activeTab === 'risks' && (
            <div className="space-y-8">
              ...
              {risks.length === 0 ? (
                <div className="bg-slate-900/40 border border-slate-800 p-24 rounded-2xl text-center text-slate-500">
                  No telemetry risk analysis computed. Generate scan rules to review hotspots.
                </div>
              ) : (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {/* Left: Module list selection */}
                  <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800 p-5 rounded-2xl space-y-4">
                    ...
                    {selectedModule ? (
                      <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                          <div className="p-4 bg-slate-950 border border-slate-850 rounded-xl space-y-1 relative group">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              <button 
                                ...
                                className="text-slate-500 hover:text-purple-400 transition active:scale-95 cursor-help"
                          ...
                          <div className="p-4 bg-slate-955 border border-slate-900 rounded-xl space-y-1 hover:border-slate-800 transition">
                              ...
                              try {
                                ...
                                return clusters.map((cluster, idx) => {
                                  ...
                                  return (
                                    <div
                                      key={cluster.id}
                                      className="p-4 bg-slate-955 border border-slate-900 rounded-xl space-y-2 hover:border-slate-800 transition"
                                    >
                                      <div className="flex justify-between items-center text-xs">
                                        <div className="flex items-center gap-2">
                                          ...
                                          {cluster.collapsed.length > 0 && (
                                            <button
                                              onClick={() => setExpandedRules(prev => ({ ...prev, [cluster.id]: !prev[cluster.id] }))}
                                              className="px-2 py-0.5 rounded-full bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 hover:border-purple-500/40 text-[8px] font-sans font-bold text-purple-300 transition flex items-center gap-0.5 active:scale-95"
                                            >
                                        ...
                                        <span className="text-slate-500 font-mono text-[9px]">LIFT: <strong className="text-purple-400">{rep.lift.toFixed(2)}</strong></span>
                                      </div>
                                      <div className="bg-slate-950 p-2.5 rounded-lg border border-slate-900 text-xs font-mono flex items-center justify-between text-slate-400 gap-4">
                                      ...
                                      {isExpanded && (
                                        <div className="mt-3 pt-3 border-t border-slate-900 space-y-2 text-[10px] font-mono text-slate-450">
                                          {cluster.collapsed.map((child, cIdx) => (
                                            <div key={cIdx} className="bg-slate-950/60 p-2 rounded-lg border border-slate-900/40 flex flex-col gap-1.5 pl-3 border-l-2 border-l-purple-500">
          ...
          {activeTab === 'pipeline' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-slate-950 border border-slate-800 hover:border-purple-500/50 text-slate-400 hover:text-purple-300 rounded-lg text-xs font-semibold transition"
                    >
                      <Download size={12} />
                    ...
                    <div
                      ...
                      className="border-2 border-dashed border-slate-800 hover:border-purple-650 transition rounded-xl p-8 text-center cursor-pointer space-y-2 bg-slate-950/20"
                    >
                      <input
                        type="file"
                        accept=".csv,.json"
                      ...
                      <p className="text-xs text-slate-400">Drag & drop CSV/JSON file here, or <span className="text-purple-400 font-bold">Browse</span></p>
                      <p className="text-[10px] text-slate-600">Required fields: module, subsystem, language, tech_stack, bug_type, severity</p>
                    </div>

                    {uploadFile && (
                      <div className="p-3 bg-slate-950 border border-slate-850 rounded-xl flex items-center justify-between text-xs gap-3">
                        ...
                        <button
                          ...
                          disabled={uploading}
                          className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg transition disabled:opacity-40"
                        >
                    ...
                    {uploadResult && (
                      <div className="p-4 bg-slate-950 border border-slate-850 rounded-xl space-y-2 text-[10px] font-mono">
                    ...
                    <form onSubmit={handleRunStreamScan} className="space-y-4 text-xs">
                      <div>
                        ...
                        <select
                          ...
                          className="block w-full px-3 py-2 bg-slate-950 border border-slate-850 rounded-lg text-white focus:outline-none"
                        >
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div>
                          ...
                          <input
                            ...
                            className="block w-full px-2 py-1.5 bg-slate-950 border border-slate-850 rounded-lg text-white focus:outline-none"
                          />
                        </div>
                        <div>
                      ...
                      {user.role === 'ADMIN' ? (
                        <button
                          type="submit"
                          disabled={scanning}
                          className="w-full mt-4 py-2.5 px-4 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 text-white font-bold rounded-lg shadow-lg hover:shadow-purple-500/10 active:scale-[0.98] transition flex items-center justify-center gap-2"
                        >
                          <Activity size={14} className={scanning ? 'animate-pulse' : ''} />
                          <span>{scanning ? 'Scan processing streaming...' : 'Run Stream Scan'}</span>
                        </button>
                      ) : (
                        <div className="p-3 bg-slate-950 border border-slate-850 rounded-lg text-slate-500 text-center font-bold">
                ...
                <div className="lg:col-span-2 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl flex flex-col justify-between min-h-[450px]">
                  <div>
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-slate-800/60 pb-4">
                      ...
                      <div className="bg-slate-950 p-1 rounded-xl border border-slate-850 flex items-center gap-1 self-start sm:self-auto font-sans">
                        <button
                          type="button"
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-xs">
                            <span className="text-purple-400 font-semibold uppercase">{sseStage || 'Idle / Awaiting connection'}</span>
                        ...
                        {loadingProfile ? (
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="flex justify-between items-center border-b border-slate-800 pb-3">
                              <div>
                                <span className="text-[10px] text-purple-400 font-bold uppercase tracking-wider font-sans">Active Ingested Dataset Profile</span>
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center font-sans">
                              ...
                              <div className="p-3 bg-slate-955 border border-slate-850 rounded-xl space-y-1 relative overflow-hidden group">
                                  ...
                                  {Object.entries(datasetProfile.completeness).map(([col, rate], idx) => (
                                    <div key={idx} className="space-y-1 text-xs">
                                      ...
                                      <div className="w-full h-1.5 bg-slate-900 border border-slate-850 rounded-full overflow-hidden">
                                        <div 
                                          className={`h-full rounded-full ${rate === 100 ? 'bg-purple-600' : 'bg-amber-500'}`}
                                          style={{ width: `${rate}%` }}
                                        />
                                      </div>
                                    </div>
          ...
          {activeTab === 'playground' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl">
                  ...
                  <form onSubmit={handleRunPlayground} className="space-y-4">
                    ...
                    {user.role === 'ADMIN' ? (
                      <button
                        type="submit"
                        disabled={comparing}
                        className="w-full mt-4 py-2.5 px-4 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800 text-white text-xs font-bold rounded-lg transition flex items-center justify-center gap-2"
                      >
                        <Cpu size={14} className={comparing ? 'animate-spin' : ''} />
                        <span>{comparing ? 'Benchmarking algorithms...' : 'Run Benchmarks'}</span>
                      </button>
                    ) : (
                      <div className="p-3 bg-slate-950 border border-slate-850 rounded-lg text-slate-500 text-center font-bold text-[10px]">
                  ...
                  {playgroundResult ? (
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-slate-900/40 border border-slate-800 p-5 rounded-2xl flex flex-col justify-between relative overflow-hidden group">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl h-[300px] flex flex-col">
                      ...
                      <div className="p-3 bg-slate-950 border border-slate-850 rounded-lg text-xs text-slate-450 flex items-center gap-2">
                        <Info size={16} className="text-purple-400 flex-shrink-0" />
                        <span>
                          {playgroundResult.fpgrowth.total_time_ms < playgroundResult.apriori.total_time_ms
                    ...
                    <div className="bg-slate-900/40 border border-slate-800 p-24 rounded-2xl text-center text-slate-500 flex flex-col items-center justify-center gap-2">
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-slate-300 transition hover:bg-slate-800"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4">
                  ...
                  {loadingHistory ? (
                    ...
                    <div className="space-y-4">
                      {scanHistory.map((scan) => (
                        <div
                          key={scan.id}
                          className="p-3 bg-slate-950 border border-slate-850 rounded-xl space-y-2 hover:border-slate-700 transition"
                        >
                          <div className="flex justify-between items-center text-xs">
                            <span className="font-mono font-bold text-purple-400">Scan #{scan.id}</span>
                          ...
                          <div className="flex gap-2 text-[10px] pt-1">
                            <button
                              ...
                              className={`flex-1 py-1 rounded text-center font-semibold transition ${
                                compareScanA === scan.id ? 'bg-purple-600 text-white' : 'bg-slate-900 hover:bg-slate-850 text-slate-450'
                              }`}
                            >
                            ...
                            <button
                              ...
                              className={`flex-1 py-1 rounded text-center font-semibold transition ${
                                compareScanB === scan.id ? 'bg-indigo-600 text-white' : 'bg-slate-900 hover:bg-slate-850 text-slate-450'
                              }`}
                            >
                  ...
                  {compareScanA !== null && compareScanB !== null && (
                    <button
                      ...
                      className="w-full py-2.5 px-4 bg-purple-600 text-white text-xs font-bold rounded-lg transition hover:bg-purple-700 flex items-center justify-center gap-1.5"
                    >
                      <Clock size={14} />
                ...
                <div className="lg:col-span-2 bg-slate-900/40 border border-slate-800 p-6 rounded-2xl min-h-[450px]">
                  {compareResults ? (
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="space-y-3">
                          ...
                          <div className="bg-slate-950 border border-slate-850 rounded-xl p-3 h-44 overflow-y-auto text-xs space-y-1 text-slate-350 scrollbar-thin">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-slate-955 border border-slate-900 rounded-xl p-4 max-h-36 overflow-y-auto font-mono text-[10px] text-slate-400 space-y-1 scrollbar-thin">
                          {compareResults.newRules.length === 0 ? (
                            ...
                            compareResults.newRules.map((rule, i) => <p key={i} className="text-purple-400">• {rule}</p>)
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      {['CRITICAL', 'HIGH', 'MEDIUM', 'LOW'].map(level => (
                        <div key={level} className="p-4 bg-slate-950 border border-slate-850 rounded-xl text-center space-y-1">
                          ...
                          <p className={`text-3xl font-mono font-extrabold ${
                            ...
                            level === 'MEDIUM' ? 'text-amber-400' : 'text-blue-400'
                          }`}>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-880 rounded-lg text-sm text-slate-300 transition hover:bg-slate-800"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4">
                  ...
                  <div className="p-4 bg-slate-950 border border-slate-850 rounded-xl space-y-2 text-xs font-mono">
                    <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="py-2.5 px-4 bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold rounded-lg transition shadow-lg hover:shadow-purple-500/10 flex items-center gap-1.5"
                  >
                    <Trash2 size={14} />
                ...
                <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4">
                  ...
                  <div className="p-4 bg-slate-950 border border-slate-850 rounded-xl space-y-3 text-xs font-mono">
                    <div>
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-slate-800">
                  ...
                  <p className="text-xs text-slate-500 mt-1">Live audit entries persisted in PostgreSQL table: <code className="bg-slate-950 px-1 py-0.5 rounded">audit_logs</code></p>
                </div>
                    ...
                    <table className="w-full text-left border-collapse text-xs">
                      ...
                      <tbody className="divide-y divide-slate-850/30 font-mono text-slate-350">
                        {auditLogs.map((logItem) => (
                          <tr key={logItem.id} className="hover:bg-slate-900/20 transition">
                            <td className="py-4 px-6 text-purple-400">#{logItem.id}</td>
      ...
      {explainModule && (
        <div className="fixed inset-0 z-50 overflow-hidden flex justify-end font-sans">
          ...
          />
          <div className="relative w-full max-w-lg h-full bg-[#0d1322]/95 border-l border-slate-800 shadow-2xl backdrop-blur-md p-6 flex flex-col justify-between transform transition-transform duration-300 ease-out overflow-y-auto text-slate-200 scrollbar-thin">
            
            <div className="flex justify-between items-start border-b border-slate-800 pb-4 mb-6">
              <div>
                <span className="text-[10px] font-bold text-purple-400 uppercase tracking-wider">Module Hotspot Drilldown</span>
                <h3 className="text-xl font-bold text-white font-mono mt-1">{explainModule}</h3>
              </div>
              <button 
                onClick={() => { setExplainModule(null); setExplainData(null); }}
                className="p-1 rounded-lg bg-slate-950/50 border border-slate-850 hover:border-slate-700 transition text-slate-400 hover:text-white"
              >
                <X size={16} />
              </button>
            </div>
            ...
            {loadingExplain ? (
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex items-center gap-6 p-4 bg-slate-950/50 border border-slate-850 rounded-xl relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent pointer-events-none" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-slate-950/50 border border-slate-850 rounded-xl space-y-2 relative overflow-hidden flex flex-col justify-between">
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent pointer-events-none" />
                    <div>
                    ...
                    {(() => {
                      ...
                      return clusters.map((cluster, idx) => {
                        ...
                        return (
                          <div 
                            key={cluster.id} 
                            className="p-3 bg-slate-955 border border-slate-900 rounded-xl space-y-2 hover:border-slate-800 transition relative overflow-hidden"
                          >
                            <div className="flex justify-between items-center text-[10px]">
                              <div className="flex items-center gap-1.5">
                                ...
                                {cluster.collapsed.length > 0 && (
                                  <button
                                    onClick={() => setExpandedRules(prev => ({ ...prev, [cluster.id]: !prev[cluster.id] }))}
                                    className="px-1.5 py-0.5 rounded-full bg-purple-500/15 hover:bg-purple-500/25 border border-purple-500/20 hover:border-purple-500/40 text-[7px] font-sans font-bold text-purple-300 transition flex items-center gap-0.5 active:scale-95"
                                  >
                                    <span>{cluster.collapsed.length} collapsed</span>
                                    <span>{isExpanded ? '▲' : '▼'}</span>
                                  </button>
                            ...
                            <div className="p-2 bg-slate-950 border border-slate-900 rounded-lg text-[9px] font-mono flex items-center justify-between text-slate-400 gap-2">
                              <span className="truncate">{rep.antecedent}</span>
                              <span className="text-purple-400 font-bold">➔</span>
                            ...
                            {isExpanded && (
                              <div className="mt-2.5 pt-2.5 border-t border-slate-900 space-y-2 text-[9px] font-mono text-slate-400">
                                {cluster.collapsed.map((child, cIdx) => (
                                  <div key={cIdx} className="bg-slate-950/65 p-2 rounded-lg border border-slate-900/40 flex flex-col gap-1 pl-2 border-l border-l-purple-500">
            ...
            <div className="border-t border-slate-800 pt-4 mt-6">
              <button
                onClick={() => { setExplainModule(null); setExplainData(null); }}
                className="w-full py-2 px-4 bg-slate-950 border border-slate-800 hover:border-slate-700 rounded-lg text-xs font-bold text-slate-350 transition hover:bg-slate-850 flex items-center justify-center gap-1.5"
              >
      ...
      {showFormulaInfo && (
        <div className="fixed inset-0 z-50 overflow-hidden flex items-center justify-center p-4 font-sans">
          ...
          />
          <div className="relative bg-[#0d1322]/98 border border-slate-800 shadow-2xl p-6 rounded-2xl max-w-md w-full backdrop-blur-md text-slate-200 space-y-4">
            ...
            <div className="space-y-3.5 text-xs text-slate-350 leading-relaxed font-sans">
              ...
              <div className="p-3.5 bg-slate-950 border border-slate-850 rounded-xl space-y-2 font-mono text-[9px] text-slate-300">
                <p className="font-bold text-purple-400">1. Raw Risk Formula:</p>
                <p className="text-slate-400 leading-normal pl-2 border-l border-slate-800">
                  RawRisk(M) = Σ (support × confidence × lift) for all matching rules in module M.
                </p>
                <p className="font-bold text-purple-400 mt-2">2. Min-Max Normalization:</p>
                <p className="text-slate-400 leading-normal pl-2 border-l border-slate-800">
