...
const HeroSection = ({ onLogin, isLoggedIn }) => {
  ...
  return (
    <section id="engine" className="relative w-full min-h-screen flex flex-col items-center justify-center pt-40 pb-20 z-10 overflow-hidden">
      ...
      {/* Holographic 3D Floating Palantir Terminal */}
      <motion.div 
      ...
      >
        ...
        <div className="relative border-2 border-amber-500/50 bg-[#050505]/95 backdrop-blur-3xl shadow-[0_40px_100px_rgba(0,0,0,0.9),0_0_40px_rgba(245,158,11,0.2)] rounded-lg overflow-hidden transform-gpu hover:rotateX-0 transition-transform duration-1000">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-[450px]">
            ...
            {/* Massive DRI Display & Recharts Live Graph */}
            <div className="md:col-span-4 border-r-2 border-amber-500/20 bg-[#050505] p-8 flex flex-col relative group overflow-hidden">
               ...
               <div className="relative z-10 flex flex-col items-center justify-center h-1/2 border-b border-amber-500/20 pb-8">
                 ...
                 <div className="text-9xl font-mono font-black text-white drop-shadow-[0_0_40px_rgba(255,255,255,0.3)] tracking-tighter">90</div>
                 <div className="text-[10px] text-[#050505] bg-amber-500 px-3 py-1 mt-4 font-black tracking-widest uppercase">CRITICAL_THREAT_LVL</div>
               </div>

               <div className="relative z-10 h-1/2 pt-8 flex flex-col">
                 <div className="text-[10px] font-mono text-amber-500 uppercase tracking-[0.2em] mb-4 font-bold flex justify-between">
            ...
            <div className="md:col-span-8 bg-[#030303] p-8 relative overflow-hidden flex flex-col">
              <div className="flex justify-between items-end mb-8 border-b-2 border-amber-500/30 pb-4">
                <div>
                  ...
                  <p className="text-[10px] font-mono text-slate-500 tracking-[0.3em]">PROCESSING 15,402 NODES/SEC</p>
                </div>
                <div className="flex gap-2">
              ...
              <div className="flex-1 space-y-3 font-mono text-xs overflow-y-auto pr-4 custom-scrollbar">
                {[
                  { m: "AUTH_MICROSERVICE", t: "SEC_LAYER, JWT", risk: "CRITICAL", c: "94.3%", rules: 142, lift: "5.42x" },
                  { m: "PAYMENT_GATEWAY_V2", t: "STRIPE, NODEJS", risk: "HIGH", c: "88.1%", rules: 89, lift: "4.12x" },
                  { m: "REDIS_SESSION_STORE", t: "CACHE, MEMORY", risk: "WARNING", c: "64.2%", rules: 45, lift: "2.88x" },
                  { m: "USER_GRAPH_DB", t: "NEO4J, QUERY", risk: "WARNING", c: "55.8%", rules: 31, lift: "2.10x" },
                  { m: "NOTIFICATION_KAFKA", t: "STREAM, EVENTS", risk: "INFO", c: "42.8%", rules: 12, lift: "1.24x" },
                ].map((row, i) => (
                  <div key={i} className="flex items-center justify-between bg-[#080808] border border-slate-800 hover:border-amber-500 p-4 transition-all duration-200 cursor-pointer group">
                    ...
                    <div className="flex items-center gap-10">
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        <span className="text-amber-500 font-black text-lg drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">{row.c}</span>
                      </div>
...
// Dense Data Architecture Section
      ...
      <div className="max-w-[1600px] mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-10">
          ...
          <div className="text-right font-mono hidden md:block">
            <div className="text-[100px] font-black text-slate-800 leading-none tracking-tighter">0.99</div>
            <div className="text-amber-500 font-bold tracking-[0.4em] uppercase">Predictive Accuracy</div>
          </div>
        </div>
            ...
            <div className="p-10 bg-[#030303] text-sm text-slate-400 font-mono flex-1 relative z-10">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span>&gt; [STG_1] Ingesting 15,482 enterprise telemetry records...</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-slate-600">00:00:03</span>
                  <span>&gt; [STG_2] Profiling dataset schema... Quality Score: 98.4%</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-slate-600">00:00:04</span>
                  <span>&gt; [STG_3] Initializing FP-Growth Engine (minSupport=0.15, minConfidence=0.7)</span>
                </div>
                <div className="flex items-center gap-4 text-amber-500 font-bold border-l-2 border-amber-500 pl-4 py-2 bg-amber-500/5">
                  <span className="text-amber-500/50">00:00:05</span>
                  <span className="drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">&gt; [MINER] Generated 2,403 raw association rules in 0.43s</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-slate-600">00:00:06</span>
                  <span>&gt; [STG_4] Executing Jaccard Deduplication Pass (threshold=0.85)...</span>
                </div>
                <div className="flex items-center gap-4 text-amber-500 font-bold border-l-2 border-amber-500 pl-4 py-2 bg-amber-500/5">
                  <span className="text-amber-500/50">00:00:07</span>
                  <span className="drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">&gt; [MINER] Retained 18 high-confidence risk hotspots</span>
                </div>
                <div className="flex items-center gap-4 text-white font-black mt-8">
                  <span className="text-slate-600 font-normal">00:00:08</span>
                  <span>&gt; [STG_8] Syncing to Redis & Streaming payload...</span>
...
export default function LandingPage({ onLogin, isLoggedIn }) {
  return (
    <div className="min-h-screen bg-[#030303] text-slate-200 selection:bg-amber-500/40 selection:text-white font-sans overflow-x-hidden">
      ...
      {/* Global strict monochrome scrollbar overrides can be added via CSS, but we keep inline classes for standard elements */}
    </div>
  );
}
