    ...
    <section id="engine" className="relative w-full min-h-screen flex flex-col items-center justify-center pt-40 pb-20 z-10 overflow-hidden">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 flex flex-col items-center mt-10 relative z-20">
        ...
        <motion.h1 
          ...
          className="text-7xl md:text-[130px] font-black tracking-tighter leading-[0.85] mb-12 uppercase text-center w-full"
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-amber-300 via-amber-500 to-amber-700 filter drop-shadow-[0_0_50px_rgba(245,158,11,0.6)]">
        ...
        <motion.p 
          ...
          className="text-2xl md:text-4xl text-slate-300 max-w-6xl font-mono leading-relaxed mb-16 tracking-tight text-center border-x-4 border-amber-500/40 px-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-[450px]">
            ...
            <div className="md:col-span-4 border-r-2 border-amber-500/30 bg-[#050505] p-8 flex flex-col relative group overflow-hidden">
               ...
               <div className="relative z-10 flex flex-col items-center justify-center h-1/2 border-b border-amber-500/30 pb-8">
                 <Shield className="w-20 h-20 text-amber-500/50 mb-6 group-hover:text-amber-500 transition-colors duration-500 drop-shadow-[0_0_15px_rgba(245,158,11,0.3)]" />
                 <div className="text-sm font-mono text-amber-500 uppercase tracking-[0.4em] mb-4 font-black">Risk_Index_Threshold</div>
                 <div className="text-7xl font-mono font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400 drop-shadow-[0_0_40px_rgba(255,255,255,0.4)] tracking-tighter uppercase">MAX_CAP</div>
            ...
            <div className="md:col-span-8 bg-[#030303] p-8 relative overflow-hidden flex flex-col">
              <div className="flex justify-between items-end mb-8 border-b-2 border-amber-500/40 pb-5">
                <div>
                  <h3 className="text-2xl font-mono text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600 font-black uppercase tracking-[0.2em] mb-2 drop-shadow-[0_0_10px_rgba(245,158,11,0.4)]">JACCARD_INFERENCE_ENGINE</h3>
      ...
      <div className="max-w-[1600px] mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-10">
          <div className="max-w-5xl">
            <h2 className="text-7xl md:text-[100px] font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 uppercase tracking-tighter mb-8 leading-[0.9]">Deep<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600 filter drop-shadow-[0_0_30px_rgba(245,158,11,0.5)]">Architecture.</span></h2>
            <p className="text-2xl text-slate-300 font-mono leading-relaxed tracking-tight border-l-8 border-amber-500 pl-8 drop-shadow-md">
          ...
          <div className="text-right font-mono hidden md:block">
            <div className="text-[120px] font-black text-slate-800 leading-none tracking-tighter drop-shadow-xl"><Shield className="w-32 h-32 inline-block text-amber-500/20 drop-shadow-[0_0_20px_rgba(245,158,11,0.2)]"/></div>
            <div className="text-amber-500 font-black tracking-[0.5em] uppercase mt-6 text-sm">PREDICTIVE_CERTAINTY</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 font-mono">
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
            <div className="flex-1 border-4 border-slate-800 bg-[#050505] p-12 hover:border-amber-500/80 transition-all duration-500 group relative overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.8)] hover:shadow-[0_0_40px_rgba(245,158,11,0.2)]">
              ...
              <h3 className="text-3xl font-black text-white mb-6 uppercase tracking-[0.2em] drop-shadow-md">ASSOCIATION_NET</h3>
              <p className="text-slate-400 leading-relaxed text-base font-bold">
            ...
            <div className="flex-1 border-4 border-slate-800 bg-[#050505] p-12 hover:border-amber-500/80 transition-all duration-500 group relative overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.8)] hover:shadow-[0_0_40px_rgba(245,158,11,0.2)]">
              ...
              <h3 className="text-3xl font-black text-white mb-6 uppercase tracking-[0.2em] drop-shadow-md">JACCARD_INDEX</h3>
              <p className="text-slate-400 leading-relaxed text-base font-bold">
          ...
          <div className="lg:col-span-8 border-4 border-slate-800 bg-[#050505] flex flex-col hover:border-amber-500/60 transition-all duration-500 relative overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <div className="p-12 border-b-4 border-slate-800 bg-[#080808] relative z-10 flex justify-between items-center">
               <div>
                  ...
                  <h3 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 uppercase tracking-[0.2em] drop-shadow-lg">SYNCHRONIZED_EVENT_STREAM</h3>
               </div>
